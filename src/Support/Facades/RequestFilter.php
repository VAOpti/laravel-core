 ...
 * @method static FilterResolver addClause(string|QueryTypeEnum $type, string|FilterOperatorsEnum|null $operator, mixed $value, ?string $attribute = null, ?string $relation = null)
